...
namespace nsChargeVoltageCtrl
{
  ...
  public:
    ...
    enum e_stateAutobalance {STATE_AUTOBAL_OFF, STATE_AUTOBAL_WAIT, STATE_AUTOBAL_WAIT_NEXT_DAY, STATE_AUTOBAL_WAIT_START_VOLTAGE, STATE_AUTOBAL_RUNING, 
      STATE_AUTOBAL_WAIT_CHARGE_VOLTAGE, STATE_AUTOBAL_FINISH};
  ...
  private:
    ...
    bool isAutobalanceTimeout(Inverter::inverterData_s &inverterData);
