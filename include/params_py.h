...
const String paramSystem PROGMEM = "{'page':["
  ...
  "}"
  "],"
  "'btn':[{'name':'save-btn','label':'Save'},{'name':'write-btn','label':'Write'}],"
  "'timer':[{'name':'read','interval':1000}]"
  "}";
    ...
    "'group':["
      "{"
        ...
        "'options':["
          ...
          "{'v':'"+String(ID_SERIAL_DEVICE_GOBELBMS)+"','l':'Gobel BMS (Test; only monitoring)'},"
          "{'v':'"+String(ID_SERIAL_DEVICE_JKBMS_CAN)+"','l':'JK BMS - CAN (Test)'}"
          "],"
