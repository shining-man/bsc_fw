    ...
    "'group':["
      "{"
        ...
        "'options':["
          ...
          "{'v':'"+String(ID_SERIAL_DEVICE_JKBMS_V13)+"','l':'JK-BMS V1.3 (IN)'}],"
...
const String paramBmsToInverter PROGMEM = "["
  ...
  "},"
  "{"
    "'label':'Zell-Spannungsabhängige Abschaltung',"
    "'type':"+String(HTML_SEPARATION)+","
  "},"
  "{"
    "'name':"+String(ID_PARAM_INVERTER_CHARGE_STOP_ZELLSPG)+","
    "'label':'Laden Stoppen bei Zellspg. gr&ouml;ßer',"
    "'unit':'mV',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'3500',"
    "'min':1500,"
  ...
  "},"
    "{"
    "'name':"+String(ID_PARAM_INVERTER_DISCHARGE_STOP_ZELLSPG)+","
    "'label':'Endladen Stoppen bei Zellspg. kleiner',"
    "'unit':'mV',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'2000',"
    "'min':1500,"
  ...
  "{"
    "'label':'Überschreibe SOC',"
    "'type':"+String(HTML_SEPARATION)+","
    "'help':'Berechnet den SOC linear anhand der Ø Zellspannung und überschreibt den von BMS gemeldeten. Für JKBMS V1.3 notwendig.'"
  "},"
  "{"
    "'name':"+String(ID_PARAM_INVERTER_OVERWRITE_SOC_EN)+","
    "'label':'Ein/Aus',"
    "'type':"+String(HTML_INPUTCHECKBOX)+","
    "'default':'0'"
  "},"
  "{"
    "'name':"+String(ID_PARAM_INVERTER_OVERWRITE_SOC_MIN_VOLTAGE)+","
    "'label':'Min. Spannung',"
    "'unit':'mV',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'2000',"
  ...
  "}," 
  "{"
    "'name':"+String(ID_PARAM_INVERTER_OVERWRITE_SOC_MAX_VOLTAGE)+","
    "'label':'Max. Spannung',"
    "'unit':'mV',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'3600',"
