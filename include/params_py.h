...
const String paramBmsToInverter PROGMEM = "{'page':["
  ...
  "{"
    ...
    "'options':["
      ...
      "{'v':'"+String(ID_CAN_DEVICE_DEYE)+"','l':'Pylontech protocol'},"
  ...
  "{"
    ...
    "'max':100,"
    "'dt':"+String(PARAM_DT_U8)+","
    "'help':'Beim Unterschreiten des eingestellten SoC wird von der Absorption in die Float Ladespannung gewechselt.'"
  "},"
  "{"
