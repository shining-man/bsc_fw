...
const String paramSystem PROGMEM = "{'page':["
  ...
  "},"
  "{"
    "'name':"+String(ID_PARAM_MQTT_HA_DISCOVERY_ENABLE)+","
    "'label':'Home Assistant Discovery enable (BETA)',"
    "'type':"+String(HTML_INPUTCHECKBOX)+","
    "'default':0,"
    "'dt':"+String(PARAM_DT_BO)+","
    "'help':'Durch das aktiveren werden nur noch MQTT Nachrichten für HA erzeugt!'"
  "},"
  "{"
  ...
  "{"
    ...
    "'default':'bsc',"
    "'dt':"+String(PARAM_DT_ST)+","
    "'help':'Wenn HA Discovery aktiv, darf kein / benutzt werden!'"
  "},"
  "{"
