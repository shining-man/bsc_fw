...
const String paramSystem PROGMEM = "{'page':["
  ...
  "{"
    ...
    "'label':'Ich bin Unterst&uuml;tzer',"
    "'type':"+String(HTML_INPUTCHECKBOX)+","
    "'default':0,"
    "'dt':"+String(PARAM_DT_BO)+","
    "'flash':'1',"
    "'help':'Willst du Unterst&uuml;tzer werden? Weitere Infos unter <a href=\"../../support/\">Unterst&uuml;tzer<a/>.'"
  "},"
  "{"
...
const String paramSerial PROGMEM = "{'page':["
  ...
  "},"
  "{"
    "'label':'Seplos, Sylcin, Gobel BMS',"
    "'type':"+String(HTML_SEPARATION)+""
  "},"
  "{"
    "'name':"+String(ID_PARAM_SERIAL2_CONNECT_TO_ID)+","
    "'label':'Anzahl Packs',"
    "'help':'Die Einstellung betrifft nur das Seplos, Sylcin und Gobel BMS an Serial 2.',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':1,"
    "'min':1,"
    "'max':8,"
...
const String paramBmsToInverter PROGMEM = "{'page':["
  ...
  "{"
    ...
    "'help':'Gibt die Tage an, nach denen wieder das Balancing gestartet werden soll.\n0=deaktivert\nAchtung: Wenn der Autobalancer aktiv, dann ist in der Ballance-Zeit der Charge-Current Cut-Off deaktiviert!',"
    "'unit':'T',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'0',"
    "'min':0,"
  ...
  "{"
    ...
    "'help':'Die Max. Ladespannung wird während dem Autobalancing auf diese Spannung angehoben.\nAchtung: Es muss die richtige Anzahl der Zellen in den Serial-Settings eingestellt sein!',"
    "'unit':'mV',"
    "'type':"+String(HTML_INPUTNUMBER)+","
    "'default':'3450',"
    "'min':3300,"
  ...
  "{"
    ...
    "'max':3500,"
    "'dt':"+String(PARAM_DT_U16)+","
    "'help':'0 = Startvoltage deaktiviert'"
  "},
  "{"
