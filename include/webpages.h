...
const String HTML_STYLE PROGMEM = "<style>"
  ...
  ".card {background-color:white;box-shadow:2px 2px 12px 1px rgba(140,140,140,.5);text-decoration:none;font-size:26px;}"
  ".cardDash {background-color:#F2F2F2;box-shadow:2px 2px 12px 1px rgba(140,140,140,.5);text-decoration:none;font-size:26px;}"
  ".card:hover {background-color:#555555;color:white;}"
  ".button {background-color:#BDBDBD;border:none;border-radius:10px;color:white;padding:16px 40px;text-decoration:none;font-size:26px;margin:2px;cursor:pointer;}"
  ".button:hover {background-color:#555555;color:white;}"
  ".button:active {color:#BDBDBD;}"
"</style>";


const String htmlPageRoot PROGMEM = "<!DOCTYPE HTML>"
"<html>"
"<head>"
  "<title>BSC</title>"
...
"<body>"
  "<div class='topnav'>"
    "<span class='hl'>Battery Safety Controller&nbsp;&nbsp;&nbsp;" + BSC_SW_VERSION + "</span>" 
  "</div>"
  "<div class='content'>"
    "<div class='cards'>"
      ...
      //"<div class='card' onclick=\"location.href='./bmsSpg/'\"><p>Celldata</p></div>"
...
const String htmlPageSettings PROGMEM = "<!DOCTYPE HTML>"
"<html>"
"<head>"
  "<title>BSC</title>"
  "<meta name='viewport' content='width=device-width, initial-scale=1'>"
...
"<body>"
  ...
  "<div class='content'>"
    ...
    "<div class='card' onclick=\"location.href='../restart/'\"><p>Reboot</p></div>"
    "</div>"
  "</div>"
"</body>"
"</html>";
...
const String htmlPageSchnittstellen PROGMEM = "<!DOCTYPE HTML>"
"<html>"
"<head>"
  "<title>BSC</title>"
  "<meta name='viewport' content='width=device-width, initial-scale=1'>"
...
const String htmlPageAlarm PROGMEM = "<!DOCTYPE HTML>"
"<html>"
"<head>"
  "<title>BSC</title>"
  "<meta name='viewport' content='width=device-width, initial-scale=1'>"
...
const String htmlPageBmsSpg PROGMEM = "<!doctype html>"
"<html>"
"<head>"
  "<meta charset='utf-8'>"
...
const String htmlPageStatus PROGMEM = "<!DOCTYPE HTML>"
"<html>"
"<head>"
  "<title>BSC</title>"
  "<meta name='viewport' content='width=device-width, initial-scale=1'>"
