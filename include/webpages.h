...
"<body>"
  "<div class='topnav'>"
    "<span class='hl'>Battery Safety Controller&nbsp;&nbsp;&nbsp;V0.3.4b</span>"
  "</div>"
  "<div class='content'>"
    "<div class='cards'>"
      "<div class='cardDash'><p>WiFi<br><meter id='meter_wifiRssi' min='0' max='70' value='0'></meter></p></div>" //WiFi RSSI
...
"function getData() {"
  ...
  "xhttp.onreadystatechange = function() {"
    "if (this.readyState == 4 && this.status == 200) {"
      ...
      //"document.getElementById('card_wifiRssi').innerHTML = values[7];" // WiFi RSSI
...
"<body>"
  ...
  "<div class='content'>"
    ...
    "<div class='card' onclick=\"location.href='./devices/'\"><p>Devices</p></div>"
...
"<body>"
  ...
  "<div class='content'>"
    "<div class='cards'>"
    "<div class='card' onclick=\"location.href='./neeyBalancer/'\"><p>NEEY Balancer</p></div>"
    "</div>"
  "</div>"
"</body>"
"</html>";
