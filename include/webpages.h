...
"<body>"
  ...
  "<div class='content'>"
    "<div class='cards'>"
      ...
      "<div class='cardBtn' style='background-color: #BFEFFF; font-size:18px' onclick=\"location.href='./support/'\"><p>Bitte denke daran, dass eine Spende eine wertvolle Möglichkeit ist, das Projekt zu unterstützen.</p></div>"
    "</div>"
    //"<div class='cards' style='background-color: #BFEFFF; padding: 10px; margin-top: 10px;'>Bitte denke daran, dass eine Spende eine wertvolle Möglichkeit ist, um das Projekt zu unterstützen und seine Weiterentwicklung zu fördern. Weitere Infos unter <u>Unterstützung</u>.</div>"
  "</div>"
"</body>"
"<script>"
"function getData() {"
...
"<body>"
  ...
  "<div class='content' style='max-width:500px'>"
    "<p>Wir sind stolz darauf, ein Teil der Open-Source-Community zu sein und möchten dir für dein Interesse an dem BSC danken. Das Projekt steht unter der MIT-Lizenz, was bedeutet, dass es frei ist und von jedem genutzt werden kann.</p>"
    "<p>Wir investieren viel Zeit und Energie in die Weiterentwicklung und Pflege dieses Projekts. Obwohl wir das aus Leidenschaft tun, benötigen wir auch deine Unterstützung, um weiterhin qualitativ hochwertige Arbeit zu leisten.</p>"
    "<p>Durch deine Spende kannst du dazu beitragen, dass das Projekt am Leben bleibt und sich weiterentwickelt. Deine finanzielle Unterstützung ermöglicht es uns, Hosting-Kosten zu decken, neue Funktionen zu implementieren, Bugs zu beheben und die allgemeine Qualität unserer Software zu verbessern.</p>"
    "<p>Deine Unterstützung ist von unschätzbarem Wert für die Fortführung des Projekts. Vielen Dank für deine Großzügigkeit!</p>"
