...
"<body>"
  "<div class='topnav'>"
    "<span class='hl'>Battery Safety Controller&nbsp;&nbsp;&nbsp;V0.7.0_T9_Seplos8S</span>"
  "</div>"
  ...
  "xhttp.onreadystatechange = function(){"
    "if (this.readyState == 4 && this.status == 200){"
      ...
      "for(k=0;k<11;k++){\n"
        ...
        "document.getElementById('bms'+k+'_maxCellDiff').innerHTML=jsonObj.bms_serial[k].maxCellDiff;\n"
      ...
      "for(k=0;k<7;k++){\n"
        ...
        "document.getElementById('btbms'+k+'_maxCellDiff').innerHTML=jsonObj.bms_bt[k].maxCellDiff;\n"
