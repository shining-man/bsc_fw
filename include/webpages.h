...
"<body>"
  "<div class='topnav'>"
    "<span class='hl'>Battery Safety Controller&nbsp;&nbsp;&nbsp;V0.5.15_T5</span>"
  "</div>"
  "<div class='content'>"
    "<div class='cards'>"
    ...
    "</div>"
    "<div class='cards' style='background-color: #BFEFFF; padding: 10px; margin-top: 10px;'>Gefällt dir das Projekt? Zeige deine Wertschätzung doch einfach mit einer Spende! Weitere Infos unter Unterstützung.</div>"
  "</div>"
"</body>"
"<script>"
"function getData() {"
...
"<body>"
  ...
  "<div class='content' style='max-width:500px'>"
    "<p>Guten Tag, liebe Fans und Unterstützer!</p>"
    "<p>Habt ihr schon mal darüber nachgedacht, wie viele Stunden an Herzblut und Koffein in die Entwicklung von Open Source Projekten fließen? Nun, wir können euch sagen, es ist eine ganze Menge!</p>"
    "<p>Aber hier ist die Sache: Wir lieben, was wir tun. Wir lieben es, innovative Lösungen zu entwickeln und wir lieben es, diese Lösungen der Welt frei zugänglich zu machen.</p>"
    "<p>Aber wir könnten ein bisschen Extra-Saft gebrauchen, um weiterhin großartige Arbeit zu leisten. Deshalb wenden wir uns an euch, unsere geschätzte Community. Wenn euch Battery Safety Controller geholfen hat, dann bitten wir euch herzlich, über eine Spende nachzudenken.</p>"
    "<p>Eure großzügige Unterstützung ermöglicht es uns, weiterhin neue Funktionen zu entwickeln und Bugs zu bekämpfen.</p>"
