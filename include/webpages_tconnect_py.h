...
"<body>"
  ...
  "</div>"
  "<div class='support-bar'><span lid='28'>Gefällt dir das Projekt? Zeige deine Wertschätzung doch einfach mit einer Spende! Weitere Infos unter </span>"
  ...
  "<div class='content'>"
    "<div class='cards'>"
      "<div class='cardDash'><p class='dash-title'><span lid='32'>WiFi</span></p><meter id='meter_wifiRssi' min='0' max='70' value='0'></meter></div>" //WiFi RSSI
      "<div class='cardDash'><p class='dash-title'><span lid='3'>System</span></p><p class='dash-value'><span id='card_system'></span></p></div>"
      "<div class='cardDash'><p class='dash-title'>MQTT</p><p class='dash-value'><span id='card_mqtt'></span></p></div>"
      "<div class='cardDash' id='card_freeheap'></div>"
      "<div class='cardDash' id='card_boottime'><p class='dash-title'><span lid='34'>Boot Time</span></p><p class='dash-value'><span id='boottime'>values[8]</span></p></div>"
      "<div class='cardDash'><p class='dash-title'>Trigger</p><table class='dash-values'>"
        "<tr><td>1..5</td><td><span id='card_alarm1'></span></td></tr>"
        "<tr><td>6..10&nbsp;&nbsp;</td><td><span id='card_alarm2'></span></td></tr></table></div>"
      "<div class='cardDash'><p class='dash-title'><span lid='4'>Inverter</span></p><table class='dash-values'>"
        "<tr><td>Chg&nbsp;</td><td><span id='cardInv0'></span>V</td></tr>"
        "<tr><td>Chg&nbsp;</td><td><span id='cardInv1'></span>A</td></tr>"
        "<tr><td>DChg&nbsp;</td><td><span id='cardInv2'></span>A</td></tr></table></div>"
    "</div>"
  "</div>"
...
"function getData() {"
  ...
  "xhttp.onreadystatechange = function() {"
    "if (this.readyState == 4 && this.status == 200) {"
      ...
      "document.getElementById('card_freeheap').innerHTML = '<p class=\"dash-title\">Free Heap</p><p class=\"dash-value\">' + values[0] + '</p>';"
      ...
      "if(values[3]=='1') {"
        ...
        "document.getElementById('card_mqtt').style.color = 'var(--good)';"
      "}else{"
        "document.getElementById('card_mqtt').innerHTML = 'disconnected';"
        "document.getElementById('card_mqtt').style.color = 'var(--bad)';"
      "}"
      "if(values[4]=='0') {"
        "document.getElementById('card_system').innerHTML = 'running';"
        "document.getElementById('card_system').style.color = 'var(--good)';"
      "}else{"
        "document.getElementById('card_system').innerHTML = 'failure (' + values[4] + ')';"
        "document.getElementById('card_system').style.color = 'var(--bad)';"
      "}"
...
"<body>"
  ...
  "</div>"
  "<div class='content'><div class='navigation-hint'><p lid='47'>Alle Einstellungen sind &uuml;ber die Navigation links erreichbar.</p></div></div>"
"</body>"
"</html>";
...
"<body>"
  ...
  "</div>"
  "<div class='content'><div class='navigation-hint'><p lid='48'>Die verf&uuml;gbaren Live-Ansichten sind &uuml;ber die Navigation links erreichbar.</p></div></div>"
"</body>"
"</html>";
...
const char htmlPageLog[] PROGMEM = "<!DOCTYPE HTML>"
"<html lang='de'>"
"<head>"
  "<title>BSC - Log</title>"
  "<meta charset='utf-8'>"
...
"</head>"
"<body>"
  "<div class='topnav'><span class='hl'>Log</span></div>"
  "<div class='content'><pre id='logContent'>Log wird geladen ...</pre></div>"
  "<script>"
    "fetch('/log').then(function(response){if(!response.ok)throw new Error(response.statusText);return response.text()}).then(function(data){document.getElementById('logContent').textContent=data}).catch(function(error){document.getElementById('logContent').textContent='Log konnte nicht geladen werden: '+error.message});"
  "</script>"
"</body>"
"</html>";
