...
bool DallasTemperature::isConnected(const uint8_t* deviceAddress,
	...
	//Serial.printf("b=%i, scratchpad=%i,%i,%i,%i,%i,%i,%i,%i, crc=%i\n",b,scratchPad[0],scratchPad[1],scratchPad[2],scratchPad[3],scratchPad[4],scratchPad[5],scratchPad[6],scratchPad[7], _wire->crc8(scratchPad, 8));
